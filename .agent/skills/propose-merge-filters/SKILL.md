...
5. Run steps 1-4 multiple times (atmost 3 times) until you are satisfied with the result.
6. Finally run `node scripts/compile-data.js` to make sure you haven't created any cycles in the filters (e.g. [a -> [b, c], b -> [a, d]]). If you have fix the created filters and re-run the script to verify.
